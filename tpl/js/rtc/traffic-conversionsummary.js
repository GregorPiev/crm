...
var summary = {
	...
	isManager: function(){
		 var that = this;
		 apiRequestBrand('getConversionShiftManagers',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
	...
	getShiftFTDsForConversion: function(){
		...
		apiRequestBrand('getShiftFTDsForConversion',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(shift_data){
	...
	getConversionWeeks: function(){
		var that = this;
		apiRequestBrand('getConversionWeeks',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
	    if(data.length!=4){
	...
	getTransactions: function(){
		...
		var unique = [];
		var transactions_wd = [];
		apiRequestBrand('getTransactionsForConversion',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
			$.each(data,function(key,row){
      	       for(var j=0;j<4;j++){
	...
	getInventivaIds: function(){
		...
		apiRequestBrand('getInventivaIds',post_data,'#summary_table_holder',true,capitalBrandName,function(data){
			$.each(that.summary_data,function(key,employee){
	...
	getTargets: function(){
	    var that = this;
	    apiRequestBrand('getTargetsForConversion',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
	...
	getExtraBonus: function(){
		var that = this;
		apiRequestBrand('getExtraForConversion',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
	...
	getWeeklyBonus: function(){
		var that = this;
		apiRequestBrand('getWeeklyBonusForConversion',$('#summary-form').serialize(),'#summary_table_holder',true,capitalBrandName,function(data){
