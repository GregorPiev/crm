...
$(document).ready(function() {
    ...
    $('#dpStart,#dpEnd,#campaigns,#desk,#employee').change(function() 
    {
        getTransactions();       
    });
...
function  getUserData(){
  	...
  	apiRequestSync('getUserData',$('#range-form').serialize(),'#employee',function(userdata){
                
  		global_userdata = userdata;
  		if (userdata.spotId==0) {
  			getLeverateEmployees();
			$(".transactionemployee").show();
