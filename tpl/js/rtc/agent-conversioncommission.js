...
var Manager_data = {
                    'Transactions':{'data':[], 'total_ftds':0, 'today_ftds':0, 'total_deposits':0, 'today_deposits':0},
...
$(document).ready(function() {
 ...
 /*     $(document).on("click","a.closeShift",function() {
       	  ...
       	  apiRequestBrand('closeConversionShift','id='+id,'#shifts_table',function(data){
       	  	 if(data) 
...
/* function openShift(){
	apiRequestBrand('openConversionShift',$('#range-form').serialize(),'#shifts_table',true,capitalBrandName,function(data){
		if(data=='open shift'){
...
function getConversionWeeks(){
	...
	apiRequestBrand('getConversionWeeks',$('#range-form').serialize(),$('#range-form'),true,capitalBrandName,function(data){
            console.info("%cgetConversionWeeks:" + JSON.stringify(data),"color:green;");
	    if(data.length!=4){
...
function  getUserSpotId(){
  	apiRequestBrand('getUserData',$('#range-form').serialize(),'#transaction_table_holder',true,capitalBrandName,function(userData){
...
function getLeverateDesk(){
	 apiRequestBrand('getLeverateDesk', $('#range-form').serialize(), '#desk',true, function(data) {
             //console.info("%cGetLeverateDesk:" + JSON.stringify(data),"color:green;");
