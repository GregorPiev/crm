...
$(document).ready(function() {
     $("h1").append(":&nbsp;&nbsp;&nbsp;&nbsp;<span style='font:normal 39px Verdana;color:navy;'>Under Construction</span>");
     exit();
   ...
   //   setBootBoxHeader(note_bootbox[0].getElementsByClassName('modal-header'));   
      ...
      $(document).on("click","a.deleteExtra",function(){
      	...
      	apiRequestBrand("deleteExtraForConversion",post_data,"#extra_table_holder",true,capitalBrandName,function(){
      ...
      $(document).on("click","a.deleteManager",function(){
      	event.preventDefault();
      	var post_data="id="+$(this).attr('data-id');
      	apiRequestBrand("deleteConversionShiftManager",post_data,"#managers_table",true,capitalBrandName,function(){
      ...
      $(document).on("click","a.assign",function(){
      	...
      	apiRequestBrand('assignForConversion',post_data,$('#transactions_table_holder'),true,capitalBrandName,function(){
      		getTransactionsForConversion();
      	});
      });
...
function deleteChangedEmployeeForConversion(id){
	apiRequestBrand('deleteChangedEmployeeForConversion','id='+id,'',true,capitalBrandName,function(data){
		if(data=='success')
...
function changeEmployeeForConversion(){
	apiRequestBrand('changeEmployeeForConversion',$('#employee-form').serialize(),'',true,capitalBrandName,function(data){
		if(data=='success')
...
function changeDuplicate(){
	apiRequestBrand('changeDuplicate',$('#duplicate-form').serialize(),$('#duplicate-form'),true,capitalBrandName,function(data){
		cleanDuplicate();
		getTransactionsForConversion();
	});
}
function getNotesForConversion(){
	apiRequestBrand('getNotesForConversion',$('#note-form').serialize(),$('#notes_table_holder'),true,capitalBrandName,function(data){
...
function getEmployeesForChange(){
    ...
    .remove()
    .end();
    apiRequestBrand('getEmployeesForConversion',$('#range-form').serialize(),'',true,capitalBrandName,function(data){
    	    $.each(data, function() {
                 $('#chooseEmployee,#managerEmployee,#sales_chooseEmployee,#sales_extraEmployee')
...
function getCampaigns_N_Agents(){
  ...
  global_agents=[];  	
  apiRequestBrand('getTransactionsForConversion',$('#range-form').serialize(),'',true,capitalBrandName,function(data){
...
function getShiftManagersModal(){
	...
	getShiftManagersForTable();
	apiRequestBrand('getUserData','','',true,capitalBrandName,function(user){
...
function getShiftManagersForTable(){
	...
	apiRequestBrand('getConversionShiftManagers',$('#dpMonth').serialize(),'#managers_table',true,capitalBrandName,function(data){
...
function addShiftManager(real_spotId){
	...
	apiRequestBrand('addConversionShiftManager',post_data,'#managers_table',true,capitalBrandName,function(data){
...
function isShiftManager(){
	...
	apiRequestBrand('getConversionShiftManagers',$('#range-form').serialize(),'',true,capitalBrandName,function(data){
...
/*	apiRequestBrand('getConversionShifts',$('#dpMonth').serialize(),'',true,capitalBrandName,function(shift_data){
		 apiRequestBrand('getFTDsForShiftManagers',$('#dpMonth').serialize(),'',true,capitalBrandName,function(ftd_data){
		    var table_data=[];
...
function addShiftFTDs(){
	...
	apiRequestBrand('addShiftFTDsForConversion',$('#shift-form').serialize(),'#shifts_table',true,capitalBrandName,function(data){
...
function deleteShiftFTDs(id){
   apiRequestBrand('deleteShiftFTDsForConversion','id='+id,'#shifts_table',true,capitalBrandName,function(data){
   	  getShiftFTDs();
   }); 	
}

function getShiftFTDs(){
	apiRequestBrand('getShiftFTDsForConversion',$('#dpMonth').serialize(),'#shifts_table',true,capitalBrandName,function(data){
		var table_data = [];
		for(var i in data){
...
function getConversionWeeks(button){
	...
	apiRequestBrand('getConversionWeeks',$('#range-form').serialize(),$('#range-form'),true,capitalBrandName,function(data){
	    if(data.length!=4){
	    	setWeeks(data);
	    }else{
...
function addWeeks(){
	...
	apiRequestBrand('addWeeksForConversion',$('#weeks-form').serialize(),$('#range-form'),true,capitalBrandName,function(data){
		$('#set').removeClass('disabled');
		getConversionWeeks();
	});
}
...
function getTransactionsForWeek(){
	...
	apiRequestBrand('getTransactionsForConversion',$('#range-form').serialize(),$('#week_table_holder'),true,capitalBrandName,function(data){
...
function addWeeklyBonus(){
	...
	console.log(post_data);
	apiRequestBrand('changeWeeklyBonusForConversion',post_data,$('#bonus_table_holder'),true,capitalBrandName,function(data){
	  console.log(data);	
	  $('#set_bonus_div').slideUp(200,function(){
   	 	for(var i=1;i<=5;i++){
   	 	  $('#row_'+i).attr('style','display:none');
...
function getWeeklyBonus(){
   ...
   apiRequestBrand('getWeeklyBonusForConversion',post_data,$('#bonus_table_holder'),true,capitalBrandName,function(data){
   	  for(var i=0;i<data.length;i++){
...
function viewWeeklyBonusForConversion(){
	var real_data=[];
	apiRequestBrand('getWeeklyBonusForConversion',$('#dpStart').serialize(),$('#view_weekly_table_holder'),true,capitalBrandName,function(data){
		for(var i=0;i<data.length;i++){
			data[i].employee=data[i].employeeId+' - '+data[i].employee;
...
function getExtraForConversion(){
	var real_data=[];
	apiRequestBrand('getExtraForConversion',$('#range-form').serialize(),$('#extra_table_holder'),true,capitalBrandName,function(data){
	   	for(var i=0;i<data.length;i++){
          data[i].employee=data[i].employeeId+' - ' +data[i].employee;
          if(data[i].employeeId==$('#employee').val()){
				real_data.push(data[i]);
...
function addExtraTable(){
	apiRequestBrand('addExtraForConversion',$('#extra-form').serialize(),$('#extra_table_holder'),true,capitalBrandName,function(){
		getExtraForConversion();
	});
}
 ...
 /*   var shift_types = ['Regular Shift','Manager Shift'];
  ...
  /*  $.ajax({
    ...
    $.ajax({
      ...
      apiRequestBrand('getTransactionsForConversion',$('#range-form').serialize(),$('#transactions_table_holder'),true,capitalBrandName,function(data){
      	...
      	if($('#target').val()<=0){
      	  if($('#target_'+week).text()==0){	
      	    bootbox.alert('<h4>Target should be positive</h4>');
          	 ...
          	 apiRequestBrand('deleteTargetForConversion',$('#target-form').serialize(),$('#transactions_table_holder'),true,capitalBrandName,function(data){
      	  ...
      	  apiRequestBrand('addTargetForConversion',$('#target-form').serialize(),$('#transactions_table_holder'),true,capitalBrandName,function(data){
...
var allSales = {
  ...
  getCampaigns : function(){
    ...
    apiRequestBrand('getTransactionsForConversion',$('#sales-form').serialize(),'',true,capitalBrandName,function(data){
  	 var unique=[];
  	 $.each(data,function(){
  ...
  clickEvents : function(){
  	...
  	$("#allSales_bootbox").on("click","a.sales_assign",function(){
  		event.preventDefault();
  		var post_data="transactionId="+$(this).attr('data-id')+"&employeeId="+$(this).attr('data-employeeId')+"&assign="+$(this).attr('data-assign');
      	apiRequestBrand('assignForConversion',post_data,'#sales_table_holder',true,capitalBrandName,function(){
      		that.getAllTransactions();
      	});
  	});
      ...
      className: "btn-success",
      callback: function() {
      	apiRequestBrand('changeEmployeeForConversion',$('#sales_employee-form').serialize(),'',true,capitalBrandName,function(data){
		   if(data=='success')
		    bootbox.alert('<h4>The employee is changed</h4>');
		   that.getAllTransactions();      
	    });
    ...
    danger: {
  	...
  	$("#sales_duplicate_button").click(function(){
  		event.preventDefault();	
	    apiRequestBrand('changeDuplicate',$('#sales_duplicate-form').serialize(),'#sales_duplicate-form',true,capitalBrandName,function(data){ 
		   that.cleanDuplicate();
		   that.getAllTransactions();
	   }); 
  	});
  ...
  viewExtraBonus : function(){
  	apiRequestBrand('getExtraForConversion',$('#range-form').serialize(),'#sales_extra_table_holder',true,capitalBrandName,function(data){
	   	for(var i=0;i<data.length;i++){
          data[i].employee=data[i].employeeId+' - ' +data[i].employee;
	   	}
  ...
  addExtraModal : function(){
      ...
      className: "btn-success",
      callback: function() {
      	apiRequestBrand('addExtraForConversion',$('#sales_extra-form').serialize(),$('#sales_extra_table_holder'),true,capitalBrandName,function(){
		  that.viewExtraBonus();
	    });
      }
    },
  ...
  deleteExtra: function(id){
  	var that = this; 
  	var post_data="id="+id;
    apiRequestBrand('deleteExtraForConversion',post_data,'#sales_extra_table_holder',true,capitalBrandName,function(){
        that.viewExtraBonus();
    });	
  },
  ...
  getAllTransactions : function(){
    ...
    $.ajax({
  	...
  	apiRequestBrand('getTransactionsForConversion',$('#sales-form').serialize(),'#sales_table_holder',true,capitalBrandName,function(data){
